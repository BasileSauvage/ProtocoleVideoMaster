...
#define LAYOUT_VIDEOS_WIDTH 800 ///< Hauteur de l'espace d'affichage des vidéos en temps normal
#define LAYOUT_VIDEOS_WIDTH_T 1066 ///< Hauteur de l'espace d'affichage des vidéos pendant la phase d'entraînement
